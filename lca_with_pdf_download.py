...
def generate_pdf(material, material_amount, energy_type, energy_amount, impacts, avg_score, energy_score, suggestions):
    ...
    for impact, vals in impacts.items():
        line = f"{impact} Impact: Material = {vals['material']:.2f}, Energy = {vals['energy']:.2f}, Total = {vals['total']:.2f} {vals['unit']}, Score = {vals['score']}/10"
...
if st.button("Calculate & Generate PDF"):
    impacts = {}
